...
export const JVSC_EXTENSION_ID = 'phohale.jupyter';
...
export const JUPYTER_HUB_EXTENSION_ID = 'phohale.jupyter-hub';
// export const JVSC_EXTENSION_ID = 'phohale.jupyter';
// export const POWER_TOYS_EXTENSION_ID = 'phohale.vscode-jupyter-powertoys';
...
export const RendererExtension = 'phohale.jupyter-renderers';
