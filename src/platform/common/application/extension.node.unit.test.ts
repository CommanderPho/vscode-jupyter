...
const stack1 = [
    ...
    '    at activateFeature (/Users/username/.vscode-insiders/extensions/phohale.vscode-jupyter-powertoys-0.1.0/out/main.js:13466:56)',
    '    at activate (/Users/username/.vscode-insiders/extensions/phohale.vscode-jupyter-powertoys-0.1.0/out/main.js:13479:9)',
    '    at activate (/Users/username/.vscode-insiders/extensions/phohale.vscode-jupyter-powertoys-0.1.0/out/main.js:14160:5)',
...
const stack2 = [
    'Error:',
    '    at kg.determineExtensionFromCallStack (/storage/username/.vscode-insiders/extensions/phohale.jupyter-2024.3.0/dist/extension.node.js:203:3695)',
    '    at F9 (/storage/username/.vscode-insiders/extensions/phohale.jupyter-2024.3.0/dist/extension.node.js:198:24742)',
    '    at Object.getKernelService (/storage/username/.vscode-insiders/extensions/phohale.jupyter-2024.3.0/dist/extension.node.js:198:26312)',
    '    at activateFeature (/storage/username/.vscode-insiders/extensions/phohale.vscode-jupyter-powertoys-0.1.0/out/main.js:335:56)',
    '    at process.processTicksAndRejections (node:internal/process/task_queues:95:5)',
    '    at async activate (/storage/username/.vscode-insiders/extensions/phohale.vscode-jupyter-powertoys-0.1.0/out/main.js:343:9)',
    '    at async activate (/storage/username/.vscode-insiders/extensions/phohale.vscode-jupyter-powertoys-0.1.0/out/main.js:13995:5)',
...
const extensions1 = [
    ...
    {
        id: 'phohale.vscode-jupyter-powertoys',
        packageJSON: { displayName: 'phohale.vscode-jupyter-powertoys' },
        extensionUri: Uri.file('/Users/username/.vscode-insiders/extensions/phohale.vscode-jupyter-powertoys-0.1.0')
    },
    {
        id: 'phohale.jupyter',
        packageJSON: { displayName: 'phohale.jupyter' },
...
const extensions2 = [
    ...
    {
        id: 'phohale.vscode-jupyter-powertoys',
        packageJSON: { displayName: 'phohale.vscode-jupyter-powertoys', version: '0.1.0' },
        extensionUri: Uri.file(
            '/storage/username/.vscode-server-insiders/extensions/phohale.vscode-jupyter-powertoys-0.1.0'
        )
    },
    {
        id: 'phohale.jupyter',
        packageJSON: { displayName: 'phohale.jupyter', version: '2024.3.0' },
        extensionUri: Uri.file('/storage/username/.vscode-server-insiders/extensions/phohale.jupyter-2024.3.0')
    }
];
...
suite(`Interpreter Service`, () => {
    ...
    test('Identify from callstack', () => {
        ...
        assert.strictEqual(extensionId, 'phohale.vscode-jupyter-powertoys');
        assert.strictEqual(displayName, 'phohale.vscode-jupyter-powertoys');
    });
